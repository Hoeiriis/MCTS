...
class TreePolicyBase {
  public:
    TreePolicyBase(std::function<std::shared_ptr<SearchNode>(std::shared_ptr<SearchNode>)> &expand, std::function<std::shared_ptr<SearchNode>(std::shared_ptr<SearchNode>)> &bestChild);
  ...
  protected:
    ...
    std::function<std::shared_ptr<SearchNode>(std::shared_ptr<SearchNode>)> m_bestChild;
};
