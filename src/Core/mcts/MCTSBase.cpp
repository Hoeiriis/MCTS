...
MCTSBase::MCTSBase(EnvironmentBase &environment,
    ...
    : m_environment(environment), m_root(SearchNode::create_SearchNode(NULL, false)), m_tree_policy(tree_policy),
...
std::shared_ptr<SearchNode> MCTSBase::search(int n_searches) {
